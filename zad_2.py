...
class Book:
    ...
    def __init__(self, library: Library, publication_date: str, author_name: str, author_surname: str, number_of_pages: int, title: str):
    ...
    def __str__(self):
        ...
        return (f"Książka: '{self.title}' Autor: {self.author_surname} ({self.publication_date}, "
...
class Order:
    ...
    def __str__(self):
        ...
        ksiazki_str = "\n".join([f"    - '{book.title}' ({book.author_surname})" for book in self.books])
...
employee2 = Employee("Piotr", "Nowak", "2018-10-15", "1985-11-20", "Warszawa", "Mokra 2", "01-001", "444-555-666")
employee3 = Employee("Ewa", "Lis", "2022-01-20", "1995-07-25", "Kraków", "Główna 3", "30-200", "777-888-999")
